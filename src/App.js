...
export const StyledButton = styled.button`padding: 8px;`;
...
function App() {
  ...
  //opean sea needs ipfs cid in the format ipfd://b47bcjfbafdgasdfdasfdasfdasf
      ...
      {blockchain.account === "" || blockchain.smartContract === null ? (
        ...
        <s.Container flex={1} ai={"center"} style={{ padding: 24 }}>
          ...
          <input type="file" name="file" onChange={changeHandler} />
            <div>
            <StyledButton onClick={handleSubmission}>Submit</StyledButton>
          </div>
          </div>

          {/*Add a file uploder here*/}
